...
% 	 	ylabel(h,'Probability Density [1/PC^2]','FontSize',16);
% 	 	caxis([0,CB_E])
...
% 	 	caxis([0,CB_E])
    ...
    caxis([-3,2])
		...
		title(tit)
%	  h = colorbar('EastOutside');
% 	 	ylabel(h,'Probability Density [1/years/PC]','FontSize',16);
% 	 	caxis([0,1e-3])
...
% 	 	caxis([-3,2])
		...
		fn  = sprintf('./Plots/LISM_Position_Command/%04d.jpeg', click); 
		print('-djpeg100',fn); 	
