...
print -djpeg100 ./Plots/Averages/AvgE_vs_H.jpeg

unix('rm ./Data/AvgE_vs_H.dat'); 

fout = fopen('./Data/AvgE_vs_H.dat','w'); 
for i=1:length(RY)
	fprintf(fout,'%e %e %e %e\n', RY(i), AVG_E(i), STD_L(i), STD_U(i)); 
end
