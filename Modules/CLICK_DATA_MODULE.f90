...
MODULE click_data
	...
	REAL(KIND=8),ALLOCATABLE,DIMENSION(:)						:: Esc_Deepest_Dist
	...
	REAL(KIND=8),ALLOCATABLE,DIMENSION(:)						:: ROOT_Esc_Deepest_Dist
...
SUBROUTINE allocate_click
  ...
  REAL(KIND=8),PARAMETER :: GB_per_real = 8.0D-9
	...
	ALLOCATE( Esc_Deepest_Dist( N_Part ) )
