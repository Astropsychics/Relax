...
SUBROUTINE universal_table_tcs( E, Targ, TCS )
	...
	USE universal, ONLY : TCS_ENERGY, TCS_X_H, TCS_X_He, TCS_X_O, TCS_X_Ar, TCS_X_H2, TCS_X_N2, TCS_X_CO, TCS_X_CO2, NL_TCS
	...
	ELSE IF (PROJ .EQ. 'O ') THEN
		IF (TRIM(Targ) .EQ. 'H')   TCS_A = TCS_X_H
		IF (TRIM(Targ) .EQ. 'He')  TCS_A = TCS_X_He	
		IF (TRIM(Targ) .EQ. 'Ar')  TCS_A = TCS_X_Ar		
		IF (TRIM(Targ) .EQ. 'O')   TCS_A = TCS_X_O		
		IF (TRIM(Targ) .EQ. 'H2')  TCS_A = TCS_X_H2		
		IF (TRIM(Targ) .EQ. 'N2')  TCS_A = TCS_X_N2		
