...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	CALL lism_grid_write ! parallel check
...
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
	...
	DO MC=1,My_N_MC
		...
		IF (TRIM(Proj) .EQ. 'H')  CALL rand_init_energy( 1.0D0, E_now )
		IF (TRIM(Proj) .EQ. 'He') CALL rand_init_energy( 4.0D0, E_now )	
		...
		!! Write initial energy and radial distance from star to file if root
