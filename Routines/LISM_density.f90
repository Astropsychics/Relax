...
SUBROUTINE LISM_density_He( r, den )
	real(kind=8)	:: r, den, tmp

	call LISM_density( r, tmp )
	den = 0.02D0*tmp
	
END SUBROUTINE LISM_density_He
...
SUBROUTINE LISM_ion_density_He( r, den )
	real(kind=8)	:: r, den, tmp

	call LISM_ion_density( r, tmp )
	den = 0.02D0*tmp
	
END SUBROUTINE LISM_ion_density_He
